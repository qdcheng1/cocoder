  ...
  init(editor: any, sessionId: string): void {
    ...
    this.collaborationSocket.on("cursorMove", (cursor) => {
      ...
      if (changeClientId in this.clientsInfo) {
        ...
        css.type = 'text/css';
        // css.innerHTML = ".editor_cursor_" + changeClientId + " { position: absolute; background: "
        //   + COLORS[this.clientNum] + ";" + " z-index:100; width:3px !important; }" ;
      ...
      let newMaker = session.addMarker(new Range(x, y, x, y + 1), 'editor_cursor_' +  changeClientId, true);
      this.clientsInfo[changeClientId]['marker'] = newMaker;
    });
